...
export const misRecetasReales = [
    // ----------------- DESAYUNO (10) -----------------
    {
        ...
        descripcion: "Tuesta las rebanadas de pan integral hasta que queden doradas y crujientes.\n\n" +
            "Mientras tanto, corta el aguacate por la mitad, retira el hueso y machaca la pulpa en un bol con un tenedor. " +
            "Añade sal, pimienta y un chorrito de aceite de oliva al gusto, y mezcla bien.\n\n" +
            "En un cazo con agua caliente (sin que llegue a hervir fuerte), añade un chorrito de vinagre y cocina el huevo poché " +
            "durante unos 3 minutos, hasta que la clara esté cuajada pero la yema quede cremosa.\n\n" +
            "Unta el aguacate sobre las tostadas, coloca el huevo encima con cuidado y añade un poco más de sal y pimienta si lo deseas. " +
    ...
    },
    {
        ...
        descripcion: "Sazona las pechugas de pollo con sal al gusto. Calienta una sartén o plancha con un chorrito de aceite de oliva y cocina el pollo a fuego medio hasta que esté dorado por fuera y completamente hecho por dentro. En paralelo, cuece o saltea las verduras hasta que queden tiernas pero ligeramente crujientes, conservando su color y textura. Sirve todo junto para una cena ligera y equilibrada.",
        ingredientes: "Pechuga de pollo (2 ud), Brócoli (200 g), Zanahoria (1 ud), Aceite de oliva, Sal",
        imagen: "https://i.ytimg.com/vi/comelhCcVtM/maxresdefault.jpg",
        tipo: "Cena"
    },
    {
        titulo: "Sopa",
